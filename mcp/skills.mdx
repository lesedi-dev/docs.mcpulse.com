...
* The connector is [read-only](/mcp/overview). The skill says so, so your agent stops looking for a write tool instead of inventing one
...
Agents can discover every page in these docs at [docs.mcpulse.com/llms.txt](https://docs.mcpulse.com/llms.txt).
