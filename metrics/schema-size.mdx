...
MCPulse's own [MCP server](/mcp/overview) registers six tools for sixteen metrics, and narrowing is a parameter rather than a name — for exactly the reason this page exists.
